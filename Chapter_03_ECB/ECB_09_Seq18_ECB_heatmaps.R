################################################################################################################################################
##                                                                                                                      
##  Plot subset of gene expression matrix based on the source code from honeybadger (credit to Jean Fan) for Sequencing 18                                                              
##                                                                                                                      
##  Date: 11 April 2020                                                                                                                    
##  
...
for (i in 1:length(Seq18.norm.gExp.matrices)){
  ...
  png(paste0("/labs/ccurtis2/mjprzy/infercnv_gastric/freeze/Sequencing18_D3_APA4_Early_WT/", sample.tmp, "/", sample.tmp, "_w_ECB.png") , width = 26, height = 12, units = 'in', res = 600)
  ...
  png(paste0("/labs/ccurtis2/mjprzy/infercnv_gastric/freeze/Sequencing18_D3_APA4_Early_WT/", sample.tmp, "/", sample.tmp, "_w_ECB_legend.png"), width = 13, height = 4, units = 'in', res = 600, type = "cairo")
