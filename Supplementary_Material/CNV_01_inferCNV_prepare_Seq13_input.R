################################################################################################################################################
##                                                                                                                      
##  Prepare input for inferCNV from Sequencing 13                                                                                     
##                                                                                                                      
##  Date: 11 March 2020                                                                                                                    
##  
...
# list files
tumor.dir <- list.files(tumor.dir, full.names = T, pattern = "Sequencing13")
...
for(w.dir in w.dir_list){
  ...
  pos.seurat.metadata <- seurat.metadata[which(seurat.metadata$Sample_Origin != "6077_WT"),]
  neg.seurat.metadata <- seurat.metadata[which(seurat.metadata$Sample_Origin == "6077_WT"),]
