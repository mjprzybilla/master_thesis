...
Seq20.norm.gExp.matrices <- Seq20.norm.gExp.matrices[grep("R1_T7|R2_T7", Seq20.norm.gExp.matrices)]
...
Seq20.annotation.files <- Seq20.annotation.files[grep("R1_T7|R2_T7", Seq20.annotation.files)]
...
Seq20.gene.ordering.files <- Seq20.gene.ordering.files[grep("R1_T7|R2_T7", Seq20.gene.ordering.files)]
...
for (i in 1:length(Seq20.norm.gExp.matrices)){
  ...
  png(paste0("/labs/ccurtis2/mjprzy/infercnv_gastric/freeze/Sequencing20_C1_T2_T7_T12_ECB_WT/", sample.tmp, "/", sample.tmp, "_w_ECB_chr3_5_9_17.png") , width = 26, height = 12, units = 'in', res = 600)
