################################################################################################################################################
##                                                                                                                      
##  Prepare input for inferCNV from Sequencing 27                                                                                        
##                                                                                                                      
##  Date: 11 March 2020                                                                                                                    
##  
...
# list files
tumor.dir <- list.files(tumor.dir, full.names = T, pattern = "Sequencing27")
...
for(w.dir in w.dir_list){
  ...
  # rename ids
  seurat.metadata[seurat.metadata == "0891_WT_P2"] <- "0891_WT"
  seurat.metadata[seurat.metadata == "0891_P_B2_LATE_102219"] <- "0891_PB2_LATE"
  seurat.metadata[seurat.metadata == "0891_P_31_EARLY"] <- "0891_P31_EARLY"
  seurat.metadata[seurat.metadata == "0891_P_41_EARLY"] <- "0891_P41_EARLY"
  seurat.metadata[seurat.metadata == "0891_P_31_LATE"] <- "0891_P31_LATE"
  seurat.metadata[seurat.metadata == "0891_P_41_LATE"] <- "0891_P41_LATE"
  seurat.metadata[seurat.metadata == "0891_P_B2_EARLY_102219"] <- "0891_PB2_EARLY"
  
  # grep the positive and negative cells
  pos.seurat.metadata <- seurat.metadata[which(seurat.metadata$Sample_Origin != "0891_WT"),]
  neg.seurat.metadata <- seurat.metadata[which(seurat.metadata$Sample_Origin == "0891_WT"),]
