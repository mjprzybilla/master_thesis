...
## SATHE DATASET
# set sample name
sample.tmp <- "merged_data_SatheEtal_freeze"
...
# remove.cells <- read.table("/labs/ccurtis2/mjprzy/scRNA_analysis/LSI_projection/merged_data_SatheEtal/merged_data_SatheEtal_removeCells.txt", col.names = "Cell_barcodes", sep = "\t")
...
new.cluster.ids <- c("Chief Cells", "PMCs", "Chief Cells", "Enterocytes", "PMCs", "Enteroendocrine Cells", 
                     "Parietal Cells", "Goblet Cells", "Goblet Cells", "PMCs", "Mucosal-like malignant Cells", "GMCs", "Mucosal-like malignant Cells",
                     "Enterocytes", "Non-Mucosal-like malignant Cells", "Proliferative Cells", "Non-Mucosal-like malignant Cells", "Enterocytes")
